export default function Project({ img, alt }) {
    return (
        <a className="relative flex justify-center w-full h-full max-h-[200px] group cursor-pointer">
            ...
            <div className="absolute m-auto w-14 h-14 md:w-20 md:h-20 lg:w-24 lg:h-24 left-0 right-0 top-0 bottom-0 fill-white bg-green-500 rounded-full flex items-center justify-center invisible group-hover:visible">
                <svg className="w-4 md:w-6 lg:w-8" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 33 42">
